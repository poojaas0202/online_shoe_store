...
function ProductScreen() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const result = await axios.get(`https://online-shoe-store-server.vercel.app/api/products/slug/${slug}`);
  ...
  const addToCartHandler = async () => {
    ...
    const { data } = await axios.get(`https://online-shoe-store-server.vercel.app/api/products/${product._id}`);
  ...
  const submitHandler = async (e) => {
    ...
    try {
      const { data } = await axios.post(
        `https://online-shoe-store-server.vercel.app/api/products/${product._id}/reviews`,
